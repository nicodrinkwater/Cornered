...
public class MenuCar {
    ...
    int size;
    Array<MenuScrap> tail, explosion;
    ...
    public MenuCar(Page page, LevelData data, MenuTrack track, TextureAtlas atlas, int size) {
        level = page;
        this.atlas = atlas;
        ...
        speed = 0;
        tail = new Array<MenuScrap>();
        explosion = new Array<MenuScrap>();
        ...
        this.actualPos = new Vector2(Constants.SCREEN_WIDTH / 2 - size/2, 650);
        fixedCentre =  new Vector2(Constants.SCREEN_WIDTH / 2 - size/2, 650);
    ...
    public void update(float delta){
        ...
        actualPos.y = fixedCentre.y + moveMent.y;
        ...
        if(state != STATE.HIT_WALL && Math.random() * delta * 60 > 0.6f){
            tail.add(new MenuScrap(this, multiTrack, atlas));
        }
